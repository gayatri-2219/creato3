...
export function LaunchPage() {
  ...
  const { address, hexAddress, initiaAddress, requestTxSync, openConnect } = useInterwovenKit()
  ...
  const handleLaunch = async () => {
    if (!address) {
      openConnect?.()
      toast.error('Connect wallet', 'Connect your wallet before launching.')
      return
    }

    if (!registered) {
      toast.error('Create profile first', 'Your on-chain creator profile must exist before launch.')
  ...
  const currentPriceLabel = manualPrice || aiSuggestion?.price || '0'
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-[#fafbfc] pb-20 pt-24 dark:from-[#1a1a2e] dark:to-[#16213e]">
      <div className="mx-auto max-w-4xl px-6">
        <div className="mb-12 text-center">
          <h1 className="text-5xl mb-4 dark:text-white">Launch Your Subscription</h1>
        ...
        {!registered ? (
          <div className="mb-8 rounded-3xl border border-[rgba(0,0,0,0.08)] bg-white p-8 text-center shadow-lg dark:border-[rgba(255,255,255,0.1)] dark:bg-[#2a2a3e]">
            ...
            <p className="text-[#6b7280] dark:text-[#9ca3af]">
              The ZIP flow expects a completed creator profile before launch, so we need your on-chain profile first.
            </p>
            <button
        ...
        <div className="space-y-8">
          <div className="rounded-3xl border border-[rgba(0,0,0,0.08)] bg-white p-8 shadow-lg dark:border-[rgba(255,255,255,0.1)] dark:bg-[#2a2a3e]">
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#a7f3d0]/20 to-[#93c5fd]/20 text-xl">
                Up
              </div>
            ...
            {files.length ? (
              <div className="mt-4 space-y-2">
                {files.map((file) => (
                  ...
                  >
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#93c5fd]/20 to-[#bfdbfe]/20 text-xs dark:text-white">
          ...
          <div className="rounded-3xl border border-[rgba(0,0,0,0.08)] bg-white p-8 shadow-lg dark:border-[rgba(255,255,255,0.1)] dark:bg-[#2a2a3e]">
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#ddd6fe]/20 to-[#fbcfe8]/20 text-xl">
                Sub
              </div>
          ...
          <div className="rounded-3xl border border-[rgba(0,0,0,0.08)] bg-white p-8 shadow-lg dark:border-[rgba(255,255,255,0.1)] dark:bg-[#2a2a3e]">
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#93c5fd]/20 to-[#bfdbfe]/20 text-xl">
                Link
              </div>
            ...
            <div className="space-y-4">
              <div>
                <label className="mb-2 block dark:text-white">Telegram</label>
                <input
                  type="text"
                  value={telegram}
              ...
              <div>
                <label className="mb-2 block dark:text-white">Discord</label>
                <input
                  type="text"
                  value={discord}
              ...
              <div>
                <label className="mb-2 block dark:text-white">Website</label>
                <input
                  type="text"
                  value={website}
          ...
          <div className="rounded-3xl border border-[rgba(0,0,0,0.08)] bg-white p-8 shadow-lg dark:border-[rgba(255,255,255,0.1)] dark:bg-[#2a2a3e]">
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#fbcfe8]/20 to-[#ddd6fe]/20 text-xl">
                AI
              </div>
            ...
            <p className="mb-6 text-[#6b7280] dark:text-[#9ca3af]">
              Get intelligent pricing recommendations based on your creator category and expected audience size.
            </p>

            <button
              onClick={handleGetAiPricing}
              disabled={pricingBusy || !expectedSubs}
            ...
            >
              <span>Spark</span>
              <span>{pricingBusy ? 'Thinking...' : 'Get AI Pricing Suggestion'}</span>
            </button>

            {showAiSuggestion && aiSuggestion ? (
              <div className="mt-6 rounded-2xl border border-[rgba(0,0,0,0.08)] bg-gradient-to-r from-[#a7f3d0]/10 to-[#93c5fd]/10 p-6 dark:border-[rgba(255,255,255,0.1)]">
                <div className="mb-4 flex items-center gap-2">
                  <span className="text-[#6ee7b7]">Spark</span>
                  <h3 className="dark:text-white">AI Recommendation</h3>
                </div>

                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <p className="mb-1 text-sm text-[#6b7280] dark:text-[#9ca3af]">Suggested Price</p>
                  ...
                  <div>
                    <p className="mb-1 text-sm text-[#6b7280] dark:text-[#9ca3af]">Market Range</p>
          ...
          <div className="rounded-3xl border border-[rgba(0,0,0,0.08)] bg-white p-8 shadow-lg dark:border-[rgba(255,255,255,0.1)] dark:bg-[#2a2a3e]">
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#6ee7b7]/20 to-[#a7f3d0]/20 text-xl">
                INIT
              </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-[#6b7280] dark:text-[#9ca3af]">
                Current launch price: {currentPriceLabel} INIT
              </p>
            </div>
          </div>
